...
function Outsourced(props) {
    ...
    return (
        <div className="Outsourced" >
            ...
            <img src={`https://github-readme-stats.vercel.app/api?username=${props.stats.login}&hide_border=true&count_private=true&show_icons=true&theme=react`}
                title="GitHub Stats"
                alt="GitHub Stats" />

            <img src={`https://github-readme-streak-stats.herokuapp.com/?user=${props.stats.login}&theme=react&hide_border=true`}
